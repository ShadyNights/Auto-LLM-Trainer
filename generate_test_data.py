...
CITIES = [
    "Kyoto, Japan", "Paris, France", "New York City, USA", "Rome, Italy", 
    "Cape Town, South Africa", "Sydney, Australia", "Bangkok, Thailand", 
    "Rio de Janeiro, Brazil", "Dubai, UAE", "London, UK", "Mumbai, India",
    "Barcelona, Spain", "Seoul, South Korea", "Berlin, Germany", "Cairo, Egypt"
]
BUDGETS = ["Budget", "Moderate", "Luxury"]
TRAVEL_STYLES = ["Solo", "Duo", "Family", "Friends", "Business"]
INTERESTS = [
    ["History", "Food"], ["Hiking", "Nature"], ["Shopping", "Nightlife"], 
    ["Art", "Museums"], ["Relaxation", "Beaches"], ["Adventure", "Sports"],
    ["Photography", "Architecture"], ["Local Culture", "Festivals"]
]
