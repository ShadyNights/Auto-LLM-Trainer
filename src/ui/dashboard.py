...
from .cards import render_analytics_card, render_feedback_form, render_itinerary_card
from .components import render_loading
from .helpers import render_spacer
from .layout import render_header, render_section


def render_hero_dashboard(metrics_data: dict | None):
    ...
    if metrics_data:
        ...
        with col3:
            ...
            render_metric(
                ...
                str(fails),
                icon="warning",
                trend_label=fail_trend,
                variant=fail_color,
                context="Pipeline failure count.",
            )
...
def render_results_dashboard(
    itinerary_text: str, itinerary_id: str, corr_id: str
